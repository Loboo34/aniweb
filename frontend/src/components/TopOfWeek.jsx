...
const TopOfWeek = () => {
  ...
  return (
    <div className=" pt-4 md:ml-4 pb-4">
      ...
      <div className="bg-gray-900 pl-4 pt-2 pb-2 flex flex-col">
        {topTen.map((anime) => (
          <div className=" flex pb-2 space-x-3 top w-full" key={anime.id}>
            <span className=" w-[60px] lg:w-1/3 flex justify-center text-center text-[#00a2ff]  text-[1.6rem]  underline-offset-8 cursor-pointer bg-green-500">
              {anime.rank}
            </span>
            <div className="w-[120px] h-[180px] p-0 lg:w-1/3 lg:h-[100px]">
              <img
            ...
            <div className="text-white text-[16px] md:text-[.9rem] lg:w-2/3">
              <p>
